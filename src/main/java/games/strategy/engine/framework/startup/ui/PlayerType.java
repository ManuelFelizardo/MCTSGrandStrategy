...
import games.strategy.triplea.ai.mctsclean.nonExploringMcts.NonExploringMctsAi;
import games.strategy.triplea.ai.mctsclean.bridgeBurningMcts.BridgeBurningMctsAi;
import games.strategy.triplea.ai.mctsclean.nonExploringMcts.NonExploringMctsRandomAi;
import games.strategy.triplea.ai.mctsclean.oepMcts.OepAi;
...
public enum PlayerType {
  ...
  OEP_AI("OEP (AI)") {
    @Override
    public Player newPlayerWithName(final String name) {
      return new OepAi(name);
    }
  },

  NEMCTS_AI("Non Exploring Mcts (AI)") {
    @Override
    public Player newPlayerWithName(final String name) {
      return new NonExploringMctsAi(name);
    }
  },

  NEMCTS_AI_Random("Non Exploring Mcts Random (AI)") {
    @Override
    public Player newPlayerWithName(final String name) {
      return new NonExploringMctsRandomAi(name);
    }
  },
  ...
  BBMCTS_AI("BBMcts (AI)") {
    @Override
    public Player newPlayerWithName(final String name) {
      return new BridgeBurningMctsAi(name);
    }
  },
