...
public class AbstractNonExploringMctsAi extends WeakAi {

  private NonExploringMcts mcts;
  @Getter
  public final MctsData mctsData;

  public AbstractNonExploringMctsAi(final String name, final MctsData mctsData) {
    super(name);
  ...
  protected void move(
    ...
    this.mcts=new NonExploringMcts(model);
