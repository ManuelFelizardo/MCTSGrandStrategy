...
import games.strategy.triplea.ai.mctsclean.AbstractMctsAi;
 ...
 */
public class MctsDummyDelegateBridge implements IDelegateBridge {
    ...
    public MctsDummyDelegateBridge(
        final WeakAi mctsAi, final GamePlayer player, final GameData data) {
        this.mctsAi=mctsAi;
        gameData = data;
        this.player = player;
    }
