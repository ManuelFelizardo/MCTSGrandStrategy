...
public class AbstractNonExploringMctsRandomAi extends WeakAi {
  private NonExploringMctsRandomPlayout mcts;
  @Getter
  public final MctsData mctsData;

  public AbstractNonExploringMctsRandomAi(final String name, final MctsData mctsData) {
    super(name);
  ...
  protected void move(
    ...
    WorldModel.cloneDataN=0;
    MctsData.mctsDataInitializeTime=0;
    MctsData.mctsDataInitializeN=0;
    ...
    this.mcts=new NonExploringMctsRandomPlayout(model);
